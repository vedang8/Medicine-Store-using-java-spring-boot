    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
        ...
        <body>
            ...
            <div class="container">
                ...
                <a class="button" href="<%=request.getContextPath()%>/addMedicine">New Medicine</a>
                <a class="button" href="<%=request.getContextPath()%>/remove/user">Manage Users</a>
                <a class="button" href="<%=request.getContextPath()%>/addCategory">New Category</a>
                <c:choose>
                        ...
                        <table cellpadding="20" cellspacing="20">
                            ...
                            <tbody>
                                <c:forEach var="t" items="${medicines}">
                                    <c:if test="${t.categoryname eq c.name}">
                                        <tr>
                                            <td>${t.id}&nbsp;&nbsp;&nbsp;</td>
                                            <td>${t.cname}&nbsp;&nbsp;&nbsp;</td>
                                            <td>${t.mname}&nbsp;&nbsp;&nbsp;</td>
                                            ...
                                            <td>${t.price}&nbsp;&nbsp;&nbsp;</td>
                                            <td>
                                                <a class="button" href="<%=request.getContextPath()%>/medicine/${t.id}">Details</a>&nbsp;
                                                <a class="button" href="<%=request.getContextPath()%>/update/medicine/${t.id}">Update</a>&nbsp;
                                                <a class="button" href="<%=request.getContextPath()%>/delete/medicine/${t.id}" onclick="return confirm('Do you really want to delete?')">Delete</a>
                                            </td>
                                        </tr>
                                    </c:if>
