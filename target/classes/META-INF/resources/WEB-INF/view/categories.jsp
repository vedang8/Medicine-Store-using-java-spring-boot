            ...
            <div class="header">
                <div class="container">
                    ...
                    <div class="header-right">
                        <a class="account" href="/addCategory">Add New</a>
                        ...
                        <table cellpadding="20" cellspacing="20">
                            <thead>
                                <tr>
                                    ...
                                    <th>Category Name &nbsp&nbsp&nbsp</th>
                            ...
                            <tbody>
                                <c:forEach var="t" items="${categories}">
                                    <tr>
                                        ...
                                        <td>${t.name}&nbsp&nbsp&nbsp</td>
                                        <td>${t.description}&nbsp&nbsp&nbsp</td>
                                        
                                        <td>
                                            <a class="button" href="<%=request.getContextPath()%>/update/category/${t.id}">Update</a> &nbsp; <a class="button" href="<%=request.getContextPath()%>/delete/category/${t.id}" onclick="return confirm('Do you really want to delete?')">Delete</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
