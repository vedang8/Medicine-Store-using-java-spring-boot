		  ...
		  <form method="POST" name="add_medicine" action="<%=request.getContextPath()%>/add/medicine" modelAttribute="medicine">
		   ...
		   <div class="form-group row">
			<label for="cname" class="col-sm-2 col-form-label">
			 Company Name</label>
			<div class="col-sm-7">
			  <input name="cname" value="${cname}" class="form-control " type="text" />
		   ...
		   <div class="form-group row">
			  ...
			  Medicine Name</label>
			  <div class="col-sm-7">
				<input name="mname" value="${mname}" class="form-control " type="text" />
			  </div>
			 </div>
			 ...
			 <div class="form-group row">
			  ...
			  <div class="col-sm-7">
				<input name="mdate" value="${mdate}"class="form-control" type="date" />
			 ...
			 <div class="form-group row">
			  ...
			  Expiry Date</label>
			  <div class="col-sm-7">
				<input name="edate" value="${edate}" class="form-control " type="date" />
