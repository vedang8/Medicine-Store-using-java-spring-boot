        ...
        <div class="header">
            <div class="container">
                ...
                <div class="header-right">
                    <a class="account" href="/add/cart/${mid}/${uid}">Add to cart</a>
                    <!-- Large modal -->
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <br /> Address : ${address}
                    <br />
                    <br /> Company Name : ${medicine.cname}
                    <br />
                    <br /> Medicine Name: ${medicine.mname}
                    <br />
                    <br /> Expire Date: ${medicine.edate}
                    <br />
                    <br /> mnf Date: ${medicine.mdate}
                    <br />
                    <br /> Price: ${medicine.price}
                    <br />
                </div>
            </div>
        </div>
