<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body>
        ...
        <div class="container">
            ...
            <form method="POST" name="update_medicine" action="<%=request.getContextPath()%>/update/category" modelAttribute="category">
                <input hidden="hidden" name="id" value="${id}" type="text" />
                Category : <input name="name" value="${mdcn.name}" type="text" /><br /><br />
                Description : <input name="description" value="${mdcn.description}" type="text" /> <br /> <br /> 
