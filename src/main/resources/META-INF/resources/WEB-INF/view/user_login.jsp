                    ...
                    <form method="POST" action="<%=request.getContextPath()%>/user/login">
                        <div class="form-group row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="username" type="text" class="form-control" id="inputEmail4" placeholder="Email" required="true">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="form-group col-md-6">
                        ...
                        <button type="submit" class="w-100 btn btn-dark" align="center">Login</button>
